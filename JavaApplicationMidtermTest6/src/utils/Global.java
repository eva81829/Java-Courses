...
public class Global {
    /* 畫面更新率 */
    public static final int UPDATE_TIME_PER_SEC = 40;   
    ...
    /* 設定圖片大小 */
    public static final int CAT_X_OFFSET = 140;
    public static final int CAT_Y_OFFSET = 140;
    public static final int BEAT1_WIDTH = 150;
    public static final int BEAT1_HEIGHT = 106;
    ...
    /* 節奏常數 */
    public static final int LINE_Y = 650;
